...
exports.run = (client, message, args) => {
  ...
  let terfiler = guild.channels.find('name', '📝slot_kom_başvuru');
  if (!terfiler) return message.reply('`📝slot_kom_başvuru` kanalını bulamıyorum.');
  ...
  const embed = new Discord.RichEmbed()
    .setColor(0xD97634)
    .setThumbnail("https://cdn.discordapp.com/attachments/478875649780613141/671665005694943232/logo_kp.png")
    .setTimestamp()
