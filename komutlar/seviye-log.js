...
exports.run = async(client, message, args) => { 
   ...
   if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(` <a:iptal:310362541807370255> Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.`);
  ...
  let kontrol3;
  if(seviyerol == null) kontrol3 = 'Seviye Rol Sistemi Aktif Değil! <a:warning:310362541807370255>'
